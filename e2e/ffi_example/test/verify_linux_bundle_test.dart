...
void main() {
  ...
  check(
    'Native-asset lib libadd.so',
    '$bundlePath/lib/libadd.so',
    nonEmpty: true,
  );
  check(
    'native_deps lib libmul.so',
    '$bundlePath/lib/libmul.so',
    nonEmpty: true,
  );
  check(
    'curated code-asset lib libsqlite3.so',
    '$bundlePath/lib/libsqlite3.so',
    nonEmpty: true,
  );
