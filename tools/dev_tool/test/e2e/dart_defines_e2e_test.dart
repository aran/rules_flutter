...
/// dev config's dartDefines as -D on its resident frontend_server; without
/// that the reloaded text renders an empty define).
void main() {
  group('dart-define e2e', () {
    test(
      '--dart-define renders and survives hot reload',
      () async {
